...
class DatasetFolder(VisionDataset):
    ...
    def __init__(self, root, loader, transform=None, target_transform=None, cached=False):
...
class Imagefolder_modified(DatasetFolder):
    ...
    def __init__(self, root, transform=None, target_transform=None,
                 loader=default_loader, cached=False):
        super(Imagefolder_modified, self).__init__(root, loader, 
                                          transform=transform,
